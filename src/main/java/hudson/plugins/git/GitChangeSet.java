...
public class GitChangeSet extends ChangeLogSet.Entry {
    ...
    private String parseHash(String hash) {
      ...
      * @param createAccountBasedOnEmail true if create new user based on author/committer's email.
      * @return {@link User}
      */
     ...
     private boolean isCreateAccountBasedOnEmail() {
         ...
         if (parent != null) {
             createAccountBasedOnEmail = ((GitSCM) parent.build.getProject().getScm()).isCreateAccountBasedOnEmail();
         }
