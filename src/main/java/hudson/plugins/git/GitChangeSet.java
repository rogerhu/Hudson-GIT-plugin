...
public class GitChangeSet extends ChangeLogSet.Entry {
     ...
     * @return {@link User}
     */
    public User findOrCreateUser(String csAuthor, String csAuthorEmail, boolean createAccountBaseOnCommitterEmail) {
        User user;
    ...
    private boolean isCreateAccountBaseOnCommitterEmail() {
        ...
        if (parent != null) {
            createAccountBaseOnCommitterEmail = ((GitSCM) parent.build.getProject().getScm()).
